...
import static infinituum.labellingcontainers.LabellingContainersClient.MODID;

public class LabelPrinterGui extends HandledScreen<LabelPrinterScreenHandler> {
    private static final Identifier BACKGROUND = new Identifier(MODID, "textures/gui/label_printer_gui.png");
    ...
    public void close() {
        ...
        ClientPlayNetworking.send(Packets.LABEL_UPDATE_PACKET_ID, buffer);
