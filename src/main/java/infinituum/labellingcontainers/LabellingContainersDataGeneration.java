...
public class LabellingContainersDataGeneration implements DataGeneratorEntrypoint {
    ...
    private void registerLanguages(FabricDataGenerator pack) {
        ...
        Consumer<String> addProvider = (languageCode) -> pack.addProvider((FabricDataGenerator dataOutput) -> new SpanishLangProvider(dataOutput, languageCode));
