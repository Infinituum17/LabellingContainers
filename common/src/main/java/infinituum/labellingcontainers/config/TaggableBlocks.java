...
public class TaggableBlocks {
    ...
    private Set<String> taggableIds = ImmutableSet.<String>builder()
            ...
            .add("mythicmetals_decorations:adamantite_chest")
            .add("mythicmetals_decorations:aquarium_chest")
            .add("mythicmetals_decorations:banglum_chest")
            .add("mythicmetals_decorations:bronze_chest")
            .add("mythicmetals_decorations:carmot_chest")
            .add("mythicmetals_decorations:celestium_chest")
            .add("mythicmetals_decorations:durasteel_chest")
            .add("mythicmetals_decorations:hallowed_chest")
            .add("mythicmetals_decorations:kyber_chest")
            .add("mythicmetals_decorations:manganese_chest")
            .add("mythicmetals_decorations:metallurgium_chest")
            .add("mythicmetals_decorations:midas_gold_chest")
            .add("mythicmetals_decorations:mythril_chest")
            .add("mythicmetals_decorations:orichalcum_chest")
            .add("mythicmetals_decorations:osmium_chest")
            .add("mythicmetals_decorations:palladium_chest")
            .add("mythicmetals_decorations:platinum_chest")
            .add("mythicmetals_decorations:prometheum_chest")
            .add("mythicmetals_decorations:quadrillum_chest")
            .add("mythicmetals_decorations:runite_chest")
            .add("mythicmetals_decorations:silver_chest")
